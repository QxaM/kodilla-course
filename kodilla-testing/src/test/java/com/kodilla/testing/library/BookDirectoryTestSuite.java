...
class BookDirectoryTestSuite {
    ...
    @Nested
    class ListBookWithConditionTest{
        @Test
    ...
    @Nested
    class ListBookInHandsOfTest{

        @Test
        void testNoBooksInUserHands(){
            //Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            LibraryUser libraryUser = new LibraryUser("Piotr", "Gliszczynski", "12345678901");
